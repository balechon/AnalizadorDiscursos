    ...
    def create_resume(self, text: str) -> dict:
        ...
        try:
            ...
            prompt = PromptTemplate(
                template="""
Genera un resumen conciso pero completo del siguiente discurso en español. El resumen debe:

1. Capturar los puntos principales y el mensaje central.
2. Incluir las ideas clave y los argumentos más importantes.
3. Evitar detalles innecesarios, centrándose en la esencia del discurso.
4. Tener una estructura clara con introducción, desarrollo y conclusión.
5. Extenderse aproximadamente 1-2 párrafos (150-250 palabras).

Asegúrate de que el resumen sea informativo y refleje fielmente el contenido y tono del discurso original.
